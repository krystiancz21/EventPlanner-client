  ...
  const onSubmit = async (data: SignUpFormData) => {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        setError(
          "Wystąpił nieznany błąd podczas rejestracji. Spróbuj ponownie."
        );
      }
    } finally {
      setIsLoading(false);
    ...
    <Box as="form" onSubmit={handleSubmit(onSubmit)} width="100%">
      <Stack gap={4}>
        {error && (
          ...
          >
            <Text color="var(--primary)" fontWeight="medium">
              {error}
            </Text>
          </Box>
        )}
        ...
        <FormButton isLoading={isLoading} loadingText="Trwa rejestracja...">
          Zarejestruj się
        </FormButton>
